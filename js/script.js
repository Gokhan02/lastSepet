...
if (window.location.href == 'https://gokhan02.github.io/lastSepet/index.html') {
    const row = document.querySelector('.row')
    const input = document.getElementById('input')

    //! ARAMA KODUNU BURADA YAZIYORUZ
...
} else if (window.location.href == 'https://gokhan02.github.io/lastSepet/sepet.html') {
    ...
    if (sepet.length == 0) {
        ...
        sepetBtn.classList.add('btn', 'btn-success', 'w-25')
